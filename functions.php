...
add_action( 'wp_enqueue_scripts', function () {
    ...
    '.va-grid,.vcp-grid{grid-template-columns:repeat(' . $layout_cols_desktop . ',minmax(0,1fr));gap:' . $layout_grid_gap . 'px;justify-content:' . $layout_grid_justify . ';}' .
    '@media (max-width:' . $layout_bp_desktop_tablet . 'px){.va-grid,.vcp-grid{grid-template-columns:repeat(' . $layout_cols_tablet . ',minmax(0,1fr));justify-content:' . $layout_grid_justify_tablet . ';}}' .
    '@media (max-width:' . $layout_bp_tablet_mobile . 'px){.va-grid,.vcp-grid{grid-template-columns:repeat(' . $layout_cols_mobile . ',minmax(0,1fr));justify-content:' . $layout_grid_justify_mobile . ';}}' .
