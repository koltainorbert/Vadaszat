...
add_action( 'login_enqueue_scripts', function () {
    ...
    #login {
        ...
        box-shadow: 0 0 60px rgba(255,0,0,.12), 0 20px 60px rgba(0,0,0,.7) !important;
    ...
    .login .forgetmenot label { color: rgba(255,255,255,.55) !important; }
    #wp-submit {
    ...
    #loginform, #lostpasswordform, #registerform { padding: 0 !important; }
    ...
    .login .notice-error, .login .error { border-color: rgba(255,0,0,.4) !important; background: rgba(255,0,0,.08) !important; color: #ffb0b0 !important; }
    #login_error { border-left: 4px solid #ff0000 !important; }
    </style>
    <script>
