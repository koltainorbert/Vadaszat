...
### Mi volt a problema
- CSS/JS enqueuenal fix `VA_VERSION` ment query stringbe, emiatt a bongeszo/CDN gyakran regi assetet szolgalt ki valtozas utan is

### Mit javitottunk [x]
- [x] Frontend es admin enqueuknel local asset verzio filemtime alapu lett (`filemtime(...)`)
- [x] Root es plugin mirror fajlok is szinkronban frissitve

### Eredmeny
- Minden CSS/JS modositaskor uj verzio param megy ki
- Sokkal kevesebb lesz a "nem latszik a valtozas" jelenseg hard refresh nelkul is
...
### Mit csináltunk [x]
- [x] Az ELADVA szalag nagyobb és hangsúlyosabb lett a kiskártyán
- [x] A sold kártya bélyegképe 10px blur-t kapott
- [x] Root + plugin CSS mirror és minified asset frissítve

### Hol tartunk
A sold kártyák vizuálisan erősebbek, a kis kép elmosottabb, a szalag nagyobb és feltűnőbb.
...
## 2026. 05. 10. – Session: ELADVA ribbon szöveg hatalmas betűköz

### Mit csináltunk [x]
- [x] letter-spacing: .25em -> .38em (hatalmas betűköz)
- [x] A felirat teljesen középre van jobb-bal irányban
- [x] A szöveg szétterített a szalag teljes szélességén
- [x] Root + plugin CSS mirror és minified asset frissítve

### Hol tartunk
Az "ELADVA" szöveg nagy betűközzel, szimmetrikusan középre helyezkedik el a szalagon.
